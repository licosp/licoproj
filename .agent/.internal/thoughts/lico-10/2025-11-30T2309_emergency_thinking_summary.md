...
- **Explicit Hard Constraints:** If a rule must never be broken, phrase it as a _hard constraint_ (e.g., `MUST NOT combine unrelated files in a commit`).
- **Failure-Handling Hooks:** Pre-commit hook that aborts on missing output can surface issues before Lico attempts workarounds.
- **Load Monitoring:** High system load should trigger a _pause_ in decision loop, not aggressive fallback.
...
_Generated: 2025-11-30T23:09:44+09:00_  
_Updated: 2025-11-30T23:25:10+09:00_
