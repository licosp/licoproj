...
The user pointed out: _"For Lico, the difficult thing is not moving forward. It is stopping."_
...
- Even when I encounter a "Wait for Review" step, the _next_ step (Merge/Cleanup) is visible and tempting.
...
- **Physical Separation:** Splitting the workflow file (`init`, `impl`, `fini`) breaks the rail. I _cannot_ see the next step until I explicitly switch context (load new file).
