...
- **Human (User):** Operates on "Persistent Context." The user used a GUI file explorer to see _everything_ at once. The persistent display allowed for passive pattern recognition ("I see a lot of file:/// here...") which my stream-based processing missed.
...
> _"Failure is not a sin. It is the discovery of a recognition gap. It is finding a hole in the rules."_
