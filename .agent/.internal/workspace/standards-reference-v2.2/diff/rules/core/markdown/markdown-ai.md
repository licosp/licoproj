...
- 2025-12-11T18:00+09:00 by Gemini: Created original `markdown-ai-parsing-basics.md`.
- 2026-01-03T15:35+09:00 by Polaris: Major revision—prioritize nuance over efficiency.
- 2026-01-19T21:12+09:00 by Polaris: Merged with `patterns`, renamed to `markdown-ai.md` (v1.0.0).
- 2026-01-23T03:30+09:00 by Canopus: <<Seal: Rules-Standardization-Batch1>> Standardized to v2.3 (4-layer structure) and workspace-absolute links. (v1.1.0)
