...
**Workflow**: Execute [idd-phase3-fini.md](../../workflows/idd-phase3-fini.md).
...
- **Prohibition**: **CHECK `/tmp`**. Files in `/tmp` are irreversibly lost upon session end. Move key data to `.agent/.internal/workspace/` before termination.
- **Logs**: Save conversation logs to `.agent/.internal/conversations/`.

### 1.3 Handoff
Create a "Next Session Handoff" note at the end of the log (or as part of [idd-phase3-fini.md](../../workflows/idd-phase3-fini.md) completion):
- Current status
...
You may refer to [idd-phase1-init.md](../../workflows/idd-phase1-init.md) for startup verification procedures.
...
| [idd-phase1-init.md](../../workflows/idd-phase1-init.md) | **Workflow**: Startup & Cleanup Recovery |
| [idd-phase3-fini.md](../../workflows/idd-phase3-fini.md) | **Workflow**: Finalization & Termination |
