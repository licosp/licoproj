...
> [!NOTE]
> 詳細は [path-notation.md](/.agent/rules/core/documentation/path-notation.md) を参照してください。

**概要**: リンクは `/.agent/...` 形式（リポジトリルートからの絶対パス）で記述する。`../` は禁止。
...
- 2026-01-13T1437 by Polaris: Shortened Section 5.2, delegated to path-notation.md (Single Source of Truth)
