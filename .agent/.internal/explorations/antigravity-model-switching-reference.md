---
title: Antigravity IDE Model Switching Reference
description: Reference document on AI model updates and runtime switching in Antigravity IDE
created: 2025-12-05
type: reference
status: active
---

# Antigravity IDE Model Switching

## Overview

Antigravity IDE supports runtime AI model switching. This document records observations from 2025-12-05 regarding model update detection and switching behavior.
...
|----------|-------|
| IDE Version | 1.11.13 |
| Commit | 56a2374ce3f3239746e0d0aae3d30552a509e20f |
| Build Date | 2025-12-03T23:14:55.584Z |
| Base Version | 1.104.0 |

## Configuration File Locations

### Linux (WSL)
- **Server Binary**: `/home/leonidas/.antigravity-server/bin/{commit}/`
- **Product Definition**: `/home/leonidas/.antigravity-server/bin/{commit}/product.json`
- **User Data**: `/home/leonidas/.gemini/antigravity/`

### Windows (Host)
- **Installation**: User's Antigravity installation directory
- **Product Definition**: `{install}/resources/app/product.json`

## Model Switching Mechanism

### Detection Method
- Model changes are detected via system metadata injection
- Format: `<USER_SETTINGS_CHANGE>` block in agent context
- Contains: Setting name, previous value, new value

### Observations
1. Model list is NOT stored in local configuration files
2. Available models are likely fetched from Google backend
3. Switching is immediate and reflected in next agent response
4. Agent cannot introspect own model identity directly

## Key Findings

### What Agent CAN Detect
- Model switch events (via injected metadata)
- IDE version and build information (via product.json)
- Installation paths and configuration structure

### What Agent CANNOT Detect
- Concrete model names (abstracted in metadata)
- Full list of available models
- Subjective performance differences

## Related Files
- Product configuration: `product.json`
- Extension manifest: `extensions/antigravity/package.json`

## Notes
- High-tier models may show minimal perceptible differences for routine tasks
- Deep reasoning tasks recommended for comparative evaluation
