...
| Path                                               | Purpose                          |
| :------------------------------------------------- | :------------------------------- |
| `.agent/cards/seed/devcontainer-card.md`           | Dev Container configuration      |
| `.agent/cards/seed/license-card.md`                | License management               |
| `.agent/cards/routine/archive-card.md`             | Archive management (New)         |
