...
- `.agent/rules/workflow/emergency-protocols.md` — 緊急対応レベル
- `.agent/workflows/emergency-backup.md` — 緊急バックアップ手順
- `.agent/workflows/recover-from-failure.md` — 復元手順
